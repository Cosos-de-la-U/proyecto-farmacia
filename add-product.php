                        ...
                        <div class="input-states">
                            <form class="row" method="POST" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="quantity" placeholder="Cantidad" name="quantity" autocomplete="off" required="" pattern="^[0-9]+$" />
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="control-label">Precio Por Unidad</label>
                                    <input type="number" class="form-control" id="rate" placeholder="Precio PA" name="rate" autocomplete="off" required="" pattern="^[0-9]+$" />
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="control-label">Precio Compra Por Unidad</label>
                                    <input type="number" class="form-control" id="rateCompra" placeholder="Precio CPA" name="rate" autocomplete="off" required pattern="^[0-9]+$" />
                                </div>
                                <div class="form-group col-md-6" hidden>
                                    <label class="control-label">PRM</label>
                                    <input type="text" class="form-control" id="mrp" placeholder="Problemas relacionado con Medicamento" name="mrp" autocomplete="off" required="" pattern="^[0-9]+$" />
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="control-label">No de Lote</label>
                                    <input type="number" class="form-control" id="Batch No" placeholder="Batch No" name="bno" autocomplete="off" required="" pattern="^[Aa-Zz]+$" />
                                </div>
                                <div class="form-group col-md-6">
